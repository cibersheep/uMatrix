...
Item {
    ...
    Column{
        ...
        Label{
            width: parent.width
            wrapMode: Text.Wrap
            text: i18n.tr ("Welcome to uMatrix!<br/>\
            <br/>\
            uMatrix is a program that allows you to use the Matrix network.")
        }
    }
    ...
    Column{
        ...
        Label{
            width: parent.width
            wrapMode: Text.Wrap
            text: i18n.tr ("To use uMatrix, you need to login with your matrix <i>user</i>.")
        }
