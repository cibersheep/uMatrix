...
UBUNTU_TRANSLATION_DOMAIN="umatrix.larreamikel"
...
aptest.commands = bash $$PWD/uMatrix/tests/autopilot/run
aptest.depends  = sub-uMatrix

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/uMatrix/tests/unit
unittest.depends  = sub-uMatrix
